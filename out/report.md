...
- **Generated (UTC)**: 2026-09-07T13:37:24.991156+00:00
- **Files scanned**: 4
...
### 1. [HIGH] JWT/JOSE — jose / JWT classical RSA or ECDSA algs

- **Location**: `js_app/crypto_demo.js`:20
...
### 2. [HIGH] RSA — Node.js crypto RSA

- **Location**: `js_app/crypto_demo.js`:7
...
### 3. [HIGH] ECDSA/ECDH — Node.js crypto EC / ECDH (+1 overlapping rules)

- **Location**: `js_app/crypto_demo.js`:10
...
### 4. [HIGH] ECDSA/ECDH — Node.js crypto EC / ECDH

- **Location**: `js_app/crypto_demo.js`:11
...
### 5. [HIGH] EdDSA — Node.js Ed25519

- **Location**: `js_app/crypto_demo.js`:14
...
### 6. [HIGH] RSA — node-forge RSA

- **Location**: `js_app/crypto_demo.js`:17
- **Rules**: `js-forge-rsa`
- **Families**: RSA
- **Priority rank**: 6
- **Priority score**: 142
...
### 7. [HIGH] RSA — WebCrypto RSA algorithm name
...
### 8. [HIGH] ECDSA/ECDH — WebCrypto classical EC curves

- **Location**: `js_app/crypto_demo.js`:24
...
### 9. [HIGH] EdDSA — Ed25519 / EdDSA classical signature (+2 overlapping rules)
...
### 10. [HIGH] ECDSA — python-ecdsa classical signatures
...
### 11. [HIGH] RSA — cryptography.io RSA API

- **Location**: `python_app/crypto_demo.py`:10
- **Rules**: `py-rsa-crypto`
- **Families**: RSA
- **Priority rank**: 11
- **Priority score**: 142
...
### 12. [HIGH] ECDSA/ECDH — cryptography.io elliptic-curve API

- **Location**: `python_app/crypto_demo.py`:13
- **Rules**: `py-ec-crypto`
- **Families**: ECDSA/ECDH
- **Priority rank**: 12
- **Priority score**: 142
...
- **Location**: `python_app/crypto_demo.py`:16
- **Rules**: `py-ed25519`
- **Families**: EdDSA
- **Priority rank**: 13
- **Priority score**: 142
...
- **Location**: `python_app/crypto_demo.py`:19
- **Rules**: `py-ecdsa`
- **Families**: ECDSA
- **Priority rank**: 14
- **Priority score**: 142
...
- **Location**: `python_app/crypto_demo.py`:4
- **Rules**: `py-ssl`
- **Families**: TLS/SSL
- **Priority rank**: 18
- **Priority score**: 90
...
### 19. [MEDIUM] TLS/SSL — stdlib ssl / TLS wrapper (check cipher suites)

- **Location**: `python_app/crypto_demo.py`:22
- **Rules**: `py-ssl`
- **Families**: TLS/SSL
- **Priority rank**: 19
- **Priority score**: 90
...
### 20. [MEDIUM] JWT — PyJWT dependency
...
- **Location**: `js_app/crypto_demo.js`:2
...
- **Location**: `python_app/crypto_demo.py`:25
- **Rules**: `py-aes`
- **Families**: AES
- **Priority rank**: 27
- **Priority score**: 41
...
- **Priority rank**: 28
- **Priority score**: 27
- **Priority reason**: score=27 (risk=info:5 + lifetime unknown→mid(+unknown penalty):20 + exposure=local hash / integrity helper:2)
- **Exposure**: hash_local
- **Quantum risk**: info
- **Owner**: 
- **Data lifetime (years)**: unknown
...
- **Location**: `python_app/crypto_demo.py`:3
- **Rules**: `py-hashlib`
- **Families**: SHA/Hash
- **Priority rank**: 29
- **Priority score**: 27
